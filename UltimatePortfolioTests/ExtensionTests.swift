...
//
//  Created by Enea Xharja on 05.09.25.
//
...
final class ExtensionTests: BaseTestCase {
    ...
    func testTagSortingIsStable() {
        ...
        tag2.name = "B Tag"
        tag2.id = UUID(uuidString: "FFFFFFFF-FFFF-4E7A-B86C-56B8010BEF4F")
    ...
    func testDecodingString() {
        ...
        XCTAssertEqual(data, "To infinity and beyond!", "The string must match DecodableString.json.")
    }
